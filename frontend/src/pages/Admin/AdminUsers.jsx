...
import { Box, Button, Typography, Stack, TextField, FormControl, Select, MenuItem, CircularProgress, Alert } from '@mui/material';
import { useNavigate } from 'react-router-dom';
import axios from 'axios';

const API_URL = 'http://localhost:3001/api/users';  // Ensure this URL matches the backend API routes
...
const AdminUsers = () => {
    ...
    const addUser = async () => {
        try {
            const response = await axios.post(API_URL, { ...newUser, role: newUser.role.toUpperCase() }, { headers: { Authorization: `Bearer ${token}` } });
