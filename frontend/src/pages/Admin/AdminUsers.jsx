...
const API_URL = 'http://localhost:3001/api/users';  // Incorrect API base URL
...
const AdminUsers = () => {
    ...
    <Box padding={2} >
        ...
        <Stack direction="row" spacing={2} alignItems="center" >
            ...
            <TextField label="Password" value={newUser.password} onChange={(e) => setNewUser({ ...newUser, password: e.target.value })} />
            <FormControl >
